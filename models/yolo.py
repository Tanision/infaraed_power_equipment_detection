...
class Model(nn.Module):
    ...
    def forward_once(self, x, profile=False):
        ...
        for m in self.model:
            ...
            if profile:
                c = isinstance(m, (Detect, IDetect, IDetect_AFPN_P345, IDetect_AFPN_P2345, IDetect_Decoupled_DyHead, IDetect_Decoupled, IDetect_DyHead_Prune, IAuxDetect, IBin, TSCODE_Detect))
...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in [nn.Conv2d, Conv, RobustConv, RobustConv2, DWConv, GhostConv, RepConv, RepConv_OREPA, DownC, 
                 ...
                 Yolov7_Tiny_E_ELAN_DBB, DiverseBranchBlock, VoVGSCSP, GSConvns, RepNCSPELAN4]:
            c1, c2 = ch[f], args[0]
            ...
            c2 = ch[f] // 2
        elif m in [Detect, TSCODE_Detect, IDetect, IDetect_AFPN_P345, IDetect_AFPN_P2345, IDetect_Decoupled_DyHead, IDetect_Decoupled, IDetect_DyHead_Prune, IAuxDetect, IBin, IKeypoint]:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='cfg/training/yolov7-tiny-dyhead-prune.yaml', help='model.yaml')
